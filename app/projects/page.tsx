      ...
      {selectedProject && (
        <div className="fixed inset-0 mountaineer-scroller z-50 overflow-y-auto bg-black flex justify-center items-start p-6 md:p-16 animate-fade-in pointer-events-auto">
          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col gap-10 py-12">
            ...
            {selectedProject.id === 1 ? (              /* ── Custom Case Study for Photobooth App (Project 01) ── */
              <div className="flex flex-col gap-32 pb-32">
                  ...
                  <div className="min-h-[60vh] flex flex-col justify-center gap-8 border-t border-white/10 pt-10">
                    <div className="flex flex-col md:flex-row gap-12 items-start">
                      <div className="flex-1 flex flex-col gap-6">
                        <div className="w-24 h-24 bg-[#ff66b2]/10 border border-[#ff66b2]/30 rounded-2xl flex items-center justify-center">
                          <span className="font-mono text-[10px] text-[#ff66b2] text-center tracking-widest leading-relaxed">[ LOGO ]<br />HERE</span>
                        </div>
                        <h3 className="text-3xl md:text-5xl font-black tracking-tighter text-white uppercase">The Web Photobooth</h3>
                        <p className="text-sm md:text-base leading-relaxed text-neutral-300 font-sans opacity-90">
                          The Photobooth App was created to bring the nostalgic, physical photobooth experience into a modern web browser. This project is a major milestone for me because it was the first time I built something that interacts directly with user devices, cameras, and real-time graphics.
                        </p>
                        <p className="text-sm md:text-base leading-relaxed text-neutral-300 font-sans opacity-90">
                          Using React, p5.js, and HTML5 Canvas elements, the app lets users take single photos or sequence layouts, apply retro styles, and download their captures as photo strips or animated GIFs.
                        </p>
                        <div className="flex flex-wrap gap-4 mt-4">
                          ...
                          <a href="/photobooth.apk" download className="inline-flex items-center gap-3 px-8 py-4 bg-transparent border border-[#ff66b2] text-[#ff66b2] font-bold text-xs tracking-widest hover:bg-[#ff66b2]/10 transition-all duration-300 w-max">
                ...
                <ScrollReveal>
                  <div className="min-h-[80vh] flex flex-col justify-center gap-6">
                    <div className="relative w-full aspect-video bg-neutral-950/80 border border-[#ff66b2]/20 hover:border-[#ff66b2]/60 rounded-2xl overflow-hidden flex flex-col justify-center items-center group transition-colors duration-500 shadow-2xl">
                      <video src="/photobooth_demo.mp4" autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover" />
                ...
                <ScrollReveal>
                  <div className="min-h-[70vh] flex flex-col justify-center gap-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                      <div className="flex flex-col gap-6 p-8 md:p-10 bg-neutral-950 border border-white/5 relative overflow-hidden rounded-2xl">
                        ...
                        <h4 className="text-3xl tracking-wide text-[#ff66b2] font-serif italic capitalize">The Struggle</h4>
                ...
                <ScrollReveal>
                  <div className="min-h-[70vh] flex flex-col justify-center gap-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-auto md:h-[600px] w-full">
                        {/* Mobile View - Tall */}
                        <div className="md:col-span-1 md:row-span-2 relative bg-neutral-950/80 border border-[#ff007f]/20 hover:border-[#ff007f]/50 rounded-3xl flex flex-col justify-center items-center group transition-all duration-500 overflow-hidden shadow-2xl h-[400px] md:h-auto">
                          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#ff007f]/10 to-transparent opacity-50" />
                          <span className="font-mono text-[10px] text-white/45 tracking-widest uppercase text-center relative z-10">[ MOBILE<br/>INTERFACE ]</span>
                        </div>
                        {/* Widescreen View - Wide */}
                        <div className="md:col-span-1 md:row-span-1 relative bg-neutral-950/80 border border-[#ff66b2]/20 hover:border-[#ff66b2]/50 rounded-3xl flex flex-col justify-center items-center group transition-all duration-500 overflow-hidden shadow-2xl h-[250px] md:h-auto">
                          <div className="absolute inset-0 bg-gradient-to-br from-[#ff66b2]/10 to-transparent opacity-50" />
                          <span className="font-mono text-[10px] text-white/45 tracking-widest uppercase text-center relative z-10">[ DESKTOP<br/>WIDESCREEN ]</span>
                        </div>
                        {/* Feature Detail - Square */}
                        <div className="md:col-span-1 md:row-span-1 relative bg-neutral-950/80 border border-[#800040]/20 hover:border-[#800040]/50 rounded-3xl flex flex-col justify-center items-center group transition-all duration-500 overflow-hidden shadow-2xl h-[250px] md:h-auto">
                          <div className="absolute inset-0 bg-gradient-to-tl from-[#800040]/20 to-transparent opacity-50" />
                          <span className="font-mono text-[10px] text-white/45 tracking-widest uppercase text-center relative z-10">[ FILTER<br/>PREVIEW ]</span>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col gap-6">
                          ...
                          <div className="space-y-6 font-sans text-sm md:text-base text-neutral-400">
                            ...
                            <div>
                              ...
                              <p className="mt-2">Leveraged browser camera permissions to handle multiple feeds and keep aspect ratios aligned on both phone screens and desktop monitors.</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              /* ── Default Showcase Layout for Other Projects ── */
